...
public class t1user extends t1userKey {
    ...
    private Boolean soilmos;

    private Boolean corpclass;
    ...
    public Boolean getSoilmos() {
        return soilmos;
    }

    public void setSoilmos(Boolean soilmos) {
        this.soilmos = soilmos;
    }

    public Boolean getCorpclass() {
        return corpclass;
    }

    public void setCorpclass(Boolean corpclass) {
    ...
    public void setLai(Boolean lai) {
        this.lai = lai;
    }
    ...
    public Object getLocno() {
        return locno;
    }

    public void setLocno(Object locno) {
        this.locno = locno;
    }
}