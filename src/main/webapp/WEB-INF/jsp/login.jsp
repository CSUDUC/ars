...
<head>
        ...
        <link href="plugins/assets/css/select2.min.css" rel="stylesheet" type="text/css" />
        <link href="plugins/assets/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN PAGE LEVEL STYLES -->
        <link href="plugins/assets/css/login-2.min.css" rel="stylesheet" type="text/css" />
...
<!-- END CORE PLUGINS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="plugins/assets/js/jquery.validate.min.js" type="text/javascript"></script>
<script src="plugins/assets/js/additional-methods.min.js" type="text/javascript"></script>
<script src="plugins/assets/js/select2.full.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
